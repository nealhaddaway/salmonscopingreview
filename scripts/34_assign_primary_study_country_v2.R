...
# Purpose: Assign one primary study country by default, retaining two or more
#          only when countries are explicitly co-primary in the title
# =============================================================================
...
title_assignments <- country_ranking |>
  ...
  dplyr::mutate(
    assignment_reason = dplyr::if_else(
      ...
      "Single country explicitly named in title",
